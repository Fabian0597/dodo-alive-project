...
class MotionStateMachine:
    ...
    def __init__(self, leg_model, math_model, constraint_fight, constraint_stance):
        ...
        flight_state = FlightPhaseState(math_model, constraint_fight)
        stance_state = StancePhaseState(math_model, constraint_stance)
